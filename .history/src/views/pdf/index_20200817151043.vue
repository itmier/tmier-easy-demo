    ...
    <div id="main">
      <div class="toolbar">
        <div class="page-control">
          ...
          <input type="text" v-model="currentPage" @keyup.enter="changePage" />
          <span>/</span>
        ...
        <div class="upload">
          <a href="javascript:;" class="file-wrapper" @click="isUrlInputShow = true">输入路径</a>
          <a href="javascript:;" class="file-wrapper">
            选择文件
