<template>
  <div class="PDF">
    <el-card style="margin-right:20px">
      <el-button type="primary" @click="resize('add')" >放大</el-button>
      <el-button type="primary" @click="resize('minus')" :disabled="big">缩小</el-button>
      <el-tag type="success">当前比例: {{ scale }}</el-tag>
    </el-card>
